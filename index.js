...
async function run() {
    try {
        ...
        /**
                   ...
                   * 
                   * app.post('/booking) //add a new booking (create)
                   * app.patch('/booking/:id) //specific one item (update)
                   * app.put('/booking/:id) //upsert= update(if exists) or insert(if doesn't exists)
                   * app.delete('/booking/:id) //specific one item (delete)
                   * 
                  */
